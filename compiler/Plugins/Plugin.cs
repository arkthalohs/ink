...
namespace Ink
{
    public interface IPlugin
    {
        ...
        void PreParse(ref string storyContent, ErrorHandler externalErrorHandler = null);
        ...
        void PostParse(ref Parsed.Story parsedStory, ErrorHandler externalErrorHandler = null);
        ...
        void PostExport(Parsed.Story parsedStory, ref Runtime.Story runtimeStory, ErrorHandler externalErrorHandler = null);
    }
}
